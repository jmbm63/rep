...
/**
 * @brief nesta funcao é suposto enviar um cliente por argumento, percorro a lista dos clientes ate encontrar o cliente
 *  depois encontro a coordenada do cliente, depois percorro o grafo com aquela coordenada e listo os meios ques estao no raio 
 * que tambem e passado por argumento
 * 
 * é chamada uma funcao "meioPretendido" que retorna o id do do meio destino
 * 
 * @param grafos 
 * @param Cliente 
 * @param meios 
...
/**
 * @brief Funcao utilizada para mostrar o grafo
 * retorna o grafo -> origem -> destino -> distancia
 * 
 * @param grafos 
 */
...
/**
 * @brief Funcao de leitura do ficheiro do grafo, em que tem as a origem, o destino e a distancia entre os dois pontos.
 * nesta funcao é chamada uma outra funçao de modo a criar a aresta entre os nos
 * 
 * @param grafos 
 */
